...
export const teachers = pgTable("teachers", {
  ...
  currentSchoolLatitude: decimal("current_school_latitude", { precision: 10, scale: 8 }),
  currentSchoolLongitude: decimal("current_school_longitude", { precision: 11, scale: 8 }),
  ...
  preferredLocationLatitude: decimal("preferred_location_latitude", { precision: 10, scale: 8 }),
  preferredLocationLongitude: decimal("preferred_location_longitude", { precision: 11, scale: 8 }),
